<nav class="sidebar">
    ...
    <div class="sidebar-body">
        <ul class="nav">
            ...
            {{--  location start  --}}
            <li class="nav-item {{ active_class(['location/*']) }}">
                <a class="nav-link" data-bs-toggle="collapse" href="#location" role="button"
                    aria-expanded="{{ is_active_route(['location/*']) }}" aria-controls="location">
                    <i class="link-icon" data-feather="mail"></i>
                    <span class="link-title">Location</span>
                    <i class="link-arrow" data-feather="chevron-down"></i>
                </a>
                <div class="collapse {{ show_class(['location/*']) }}" id="location">
                    <ul class="nav sub-menu">
                        <li class="nav-item">
                            <a href="{{ url('admin/location/divisions') }}"
                                class="nav-link {{ active_class(['location/divisions']) }}">Divistions</a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ url('admin/location/districts') }}"
                                class="nav-link {{ active_class(['location/districts']) }}">Districts</a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ url('admin/location/upazilas') }}"
                                class="nav-link {{ active_class(['location/upazilas']) }}">Upazilas</a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ url('admin/location/unions') }}"
                                class="nav-link {{ active_class(['location/unions']) }}">Unions</a>
                        </li>
                    </ul>
                </div>
            </li>
            ...
            {{--  designation start  --}}
            <li class="nav-item {{ active_class(['designation/*']) }}">
                <a class="nav-link" data-bs-toggle="collapse" href="#designation" role="button"
                    aria-expanded="{{ is_active_route(['designation/*']) }}" aria-controls="designation">
                    <i class="link-icon" data-feather="mail"></i>
                    <span class="link-title">Designation</span>
                    <i class="link-arrow" data-feather="chevron-down"></i>
                </a>
                <div class="collapse {{ show_class(['designation/*']) }}" id="designation">
                    <ul class="nav sub-menu">
                        <li class="nav-item">
                            <a href="{{ route('designations.index') }}" class="nav-link">Designation List</a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('designations.create') }}" class="nav-link">Create</a>
                        </li>
                    </ul>
                </div>
            </li>
            ...
            {{--  organization start  --}}
            <li class="nav-item {{ active_class(['organization/*']) }}">
                <a class="nav-link" data-bs-toggle="collapse" href="#organization" role="button"
                    aria-expanded="{{ is_active_route(['organization/*']) }}" aria-controls="organization">
                    <i class="link-icon" data-feather="mail"></i>
                    <span class="link-title">Organization</span>
                    <i class="link-arrow" data-feather="chevron-down"></i>
                </a>
                <div class="collapse {{ show_class(['organization/*']) }}" id="organization">
                    <ul class="nav sub-menu">
                        <li class="nav-item">
                            <a href="{{ route('organizations.index') }}" class="nav-link">Organization List</a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('organizations.create') }}" class="nav-link">Create</a>
                        </li>
                    </ul>
                </div>
            </li>
            ...
            {{--  poll start  --}}
            <li class="nav-item {{ active_class(['poll/*']) }}">
                <a class="nav-link" data-bs-toggle="collapse" href="#poll" role="button"
                    aria-expanded="{{ is_active_route(['poll/*']) }}" aria-controls="poll">
                    <i class="link-icon" data-feather="mail"></i>
                    <span class="link-title">Poll</span>
                    <i class="link-arrow" data-feather="chevron-down"></i>
                </a>
                <div class="collapse {{ show_class(['poll/*']) }}" id="poll">
                    <ul class="nav sub-menu">
                        <li class="nav-item">
                            <a href="{{ route('polls.index') }}" class="nav-link">Poll List</a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('polls.create') }}" class="nav-link">Create</a>
                        </li>
                    </ul>
                </div>
            </li>
            ...
            <li class="nav-item {{ active_class(['forms/*']) }}">
                ...
                <div class="collapse {{ show_class(['forms/*']) }}" id="forms">
                    <ul class="nav sub-menu">
                        <li class="nav-item">
                            <a href="{{ url('admin/forms/basic-elements') }}"
            ...
            <li class="nav-item {{ active_class(['tables/*']) }}">
                ...
                <div class="collapse {{ show_class(['tables/*']) }}" id="tables">
                    <ul class="nav sub-menu">
                        <li class="nav-item">
                            <a href="{{ url('admin/tables/basic-tables') }}"
                                class="nav-link {{ active_class(['tables/basic-tables']) }}">Basic Tables</a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ url('admin/tables/data-table') }}"
            ...
            <li class="nav-item {{ active_class(['auth/*']) }}">
                ...
                <div class="collapse {{ show_class(['auth/*']) }}" id="auth">
                    <ul class="nav sub-menu">
                        ...
                        <li class="nav-item">
                            <a href="{{ url('admin/auth/register') }}"
            ...
            <li class="nav-item {{ active_class(['error/*']) }}">
                ...
                <div class="collapse {{ show_class(['error/*']) }}" id="error">
                    <ul class="nav sub-menu">
                        <li class="nav-item">
                            <a href="{{ url('admin/error/404') }}"
                                class="nav-link {{ active_class(['error/404']) }}">404</a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ url('admin/error/500') }}"
