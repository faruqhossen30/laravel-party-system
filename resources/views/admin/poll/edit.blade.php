            ...
            <div class="card-body">
                <form action="{{ route('polls.update',$poll->id) }}" method="POST"  class="forms-sample">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="title" class="form-control" id="forName" value="{{ $poll->title }}" autocomplete="off" placeholder="Title">
                   </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <form action="{{ route('optionupdate.update', $option->id) }}" method="post" >
                                       ...
                                       <div class="d-flex mb-2" style="width: 50%">
                                        <input type="text" class="form-control" name="option" value="{{ $option->option }}" width="80%">
